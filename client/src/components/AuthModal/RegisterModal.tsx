            ...
            >
                <Box sx={style}>
                    ...
                    >
                        ...
                        <TextField
                            color={
                                suiteResult.isValid("first_name")
                                    ? "success"
                                    : "error"
                            }
                            placeholder="First Name"
                            error={
                                suiteResult.hasErrors("first_name")
                                    ? true
                                    : false
                            }
                        ...
                        <TextField
                            color={
                                suiteResult.isValid("last_name")
                                    ? "success"
                                    : "error"
                            }
                            placeholder="Last Name"
                            error={
                                suiteResult.hasErrors("last_name")
                                    ? true
                                    : false
                            }
                        ...
                        <TextField
                            ...
                            color={
                                suiteResult.isValid("email")
                                    ? "success"
                                    : "error"
                            }
                            placeholder="Email Address"
                            error={
                                suiteResult.hasErrors("email") ? true : false
                            }
